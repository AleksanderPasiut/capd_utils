...
public:
    ...
    ENP(const VectorType& extension_values,
        ...
        MapUArgs... map_u_args)
            : m_map_u(map_u_args...)
            , m_extension(Carina::ExtensionMap<MapT>::create(extension_values, in_idx_list ))
            , m_projection(Carina::ProjectionMap<MapT>::create(m_map_u.imageDimension(), out_idx_list))
    {
